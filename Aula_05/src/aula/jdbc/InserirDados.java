...
public class InserirDados extends JFrame {
	...
	public InserirDados() throws SQLException{
		...
		String sFonte = "jdbc:postgresql://localhost:5432/jdbc";
		...
		try{
			...
			st.executeUpdate ("INSERT INTO Produto (codProduto, produto) values(1,'Arroz');");
			st.executeUpdate ("INSERT INTO Produto (codProduto, produto) values(2,'Feijão');");
			st.executeUpdate ("INSERT INTO Produto (codProduto, produto) values(3,'Macarrão');");
		}catch(SQLException eSQL){
